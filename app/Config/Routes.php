...
$routes->get('agenda', '\App\Controllers\PublicPortalController::agenda');
$routes->get('cari', '\App\Controllers\PublicPortalController::search');
$routes->get('api/prayer-times-today', '\App\Controllers\PublicPortalController::prayerTimesJson');
