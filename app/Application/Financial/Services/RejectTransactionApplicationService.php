...
class RejectTransactionApplicationService
{
    ...
    public function execute(RejectTransactionRequest $request): FinancialTransactionResponse
    {
        ...
        $transaction->reject($request->approverUserId, $request->notes);
