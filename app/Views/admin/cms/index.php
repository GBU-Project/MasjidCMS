...
<!-- Tab Navigation Bar -->
<div style="display: flex; border-bottom: 1px solid var(--border-light); margin-bottom: 20px; gap: 24px; flex-wrap: wrap;">
    ...
    <a href="<?= site_url('admin/cms?tab=agenda') ?>" style="padding: 12px 0; text-decoration: none; font-size: 14px; font-weight: 600; color: <?= ($activeTab === 'agenda') ? 'var(--primary-600)' : 'var(--text-secondary)' ?>; border-bottom: 2px solid <?= ($activeTab === 'agenda') ? 'var(--primary-600)' : 'transparent' ?>;">📅 Agenda</a>
    <a href="<?= site_url('admin/cms?tab=program') ?>" style="padding: 12px 0; text-decoration: none; font-size: 14px; font-weight: 600; color: <?= ($activeTab === 'program') ? 'var(--primary-600)' : 'var(--text-secondary)' ?>; border-bottom: 2px solid <?= ($activeTab === 'program') ? 'var(--primary-600)' : 'transparent' ?>;">🚩 Program & Kegiatan</a>
    <a href="<?= site_url('admin/cms?tab=layanan') ?>" style="padding: 12px 0; text-decoration: none; font-size: 14px; font-weight: 600; color: <?= ($activeTab === 'layanan') ? 'var(--primary-600)' : 'var(--text-secondary)' ?>; border-bottom: 2px solid <?= ($activeTab === 'layanan') ? 'var(--primary-600)' : 'transparent' ?>;">🤝 Layanan Masjid</a>
