    ...
    <form action="<?= site_url('admin/hero-slides/store') ?>" method="POST">
        ...
        <div class="panel-card" style="background: white; border: 1px solid var(--border-light); border-radius: 12px; padding: 24px; margin-bottom: 24px;">
            ...
            <div style="margin-bottom: 16px;">
                ...
                <input type="text" name="title" required value="<?= esc(old('title')) ?>" placeholder="Contoh: Pusat Ibadah, Dakwah & Pemberdayaan Umat" style="width: 100%; padding: 10px 14px; border: 1px solid var(--border-light); border-radius: 8px; font-size: 14px;">
            </div>
